 ...
 */
public abstract class Hilt_HeroesFragment<viewBinding extends ViewBinding> extends BaseFragment<viewBinding> implements GeneratedComponentManagerHolder {
  ...
  Hilt_HeroesFragment(
      Function3<? super LayoutInflater, ? super ViewGroup, ? super Boolean, ? extends viewBinding> inflate) {
    super(inflate);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HeroesFragment_GeneratedInjector) this.generatedComponent()).injectHeroesFragment(UnsafeCasts.<HeroesFragment>unsafeCast(this));
    }
  }
