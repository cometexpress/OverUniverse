 ...
 */
public abstract class Hilt_ModesFragment<viewBinding extends ViewBinding> extends BaseFragment<viewBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ModesFragment_GeneratedInjector) this.generatedComponent()).injectModesFragment(UnsafeCasts.<ModesFragment>unsafeCast(this));
    }
  }
