...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        private final RetrofitRxjava2LibraryAccessors laccForRetrofitRxjava2LibraryAccessors = new RetrofitRxjava2LibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at retrofit.rxjava2
         */
        public RetrofitRxjava2LibraryAccessors getRxjava2() {
            return laccForRetrofitRxjava2LibraryAccessors;
        }
    ...
    public static class RetrofitRxjava2LibraryAccessors extends SubDependencyFactory {

        public RetrofitRxjava2LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getAdapter() {
                return create("retrofit.rxjava2.adapter");
        }
    ...
    public static class RoomLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public RoomLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for compliler (androidx.room:room-compiler)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompliler() {
                return create("room.compliler");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: roomDB (2.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: rxJava2 (2.2.21)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
